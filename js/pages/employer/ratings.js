...
const MOCK_RATINGS = [
  {
    ...
    rating: 5,
    comment:
      'The employer was very professional and provided clear instructions. Payment was released immediately after the job was done. Highly recommended!',
    date: '2026-03-24',
  },
  {
    id: 2,
    ...
    rating: 5,
    comment:
      'Great experience working as a rider. The app made it easy to manage deliveries. Good support from the employer as well.',
    date: '2026-03-22',
  },
  {
    id: 3,
    ...
    rating: 4,
    comment:
      'Nice environment to work in. Tasks were manageable, and the staff were friendly. Looking forward to more jobs from this employer.',
    date: '2026-03-15',
  },
  {
    id: 4,
    ...
    rating: 5,
    comment:
      'The tutoring sessions were well-organized. The employer was very supportive and provided all necessary materials. Excellent communication!',
    date: '2026-03-10',
  },
  {
    id: 5,
    ...
    rating: 5,
    comment:
      'Fun and creative job! The employer gave me creative freedom while providing clear goals. Prompt payment as well.',
    date: '2026-03-05',
  },
];
